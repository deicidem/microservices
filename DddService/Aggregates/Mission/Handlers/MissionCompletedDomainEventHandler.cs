...
public class MissionCompleteedDomainEventHandler : INotificationHandler<MissionCompletedDomainEvent>
{
    ...
    {
        var missionCompleteedMessage = new MissionCompletedMessage(notification.Id, notification.Difficulty, notification.Status.GetDisplayName(), notification.Reinforcements, notification.Squad, notification.ObjectivesCompleted, new DateTimeOffset(DateTime.UtcNow).ToUnixTimeSeconds().ToString());
